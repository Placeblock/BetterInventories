...
/**
 * A {@link BaseGUIItem} with the ability to get clicked.
...
public abstract class BaseGUIButton extends BaseGUIItem {
    /**
     ...
     */
    public BaseGUIButton(GUI gui, ItemStack item, int cooldown, Sound clickSound, String permission) {
        super(gui, item);
    ...
    public static abstract class Builder<B extends Builder<B, P>, P extends BaseGUIButton> extends BaseGUIItem.Builder<B, P> {
