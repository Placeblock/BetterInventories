...
public abstract class BaseSubmitGUIButton extends BaseGUIButton {
    /**
     ...
     */
    public BaseSubmitGUIButton(GUI gui, ItemStack item, int cooldown, Sound sound, String permission, ItemStack submitItem, int submitDelay) {
    ...
    public static abstract class Builder<B extends Builder<B, P>, P extends BaseSubmitGUIButton> extends BaseGUIButton.Builder<B, P> {
